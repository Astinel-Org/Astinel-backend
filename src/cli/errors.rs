...
pub enum CliError {
    ...
    #[error("Parse error: {0}")]
    Parse(#[from] crate::scanner::parser::ParserError),
...
impl From<crate::cli::errors::CliError> for io::Error {
    fn from(e: crate::cli::errors::CliError) -> Self {
...
mod tests {
    ...
    fn error_maps_to_expected_exit_code() {
        ...
        assert_eq!(
            CliError::Internal("bug".into()).exit_code(),
