...
use crate::core::{Ast, RuleRegistry};
...
mod tests {
    use super::*;
    use crate::core::{RuleId, RuleRegistry, Severity};
    use crate::scanner::rules::testing::{TestProject, TestRuleBuilder};
    ...
    fn runner_empty_project() {
        ...
        registry
            .register(Box::new(
                TestRuleBuilder::new("empty-rule")
