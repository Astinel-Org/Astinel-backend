...
use crate::core::DiagnosticSpan;
use crate::scanner::parser::ast::*;
use crate::scanner::parser::error::ParserError;
...
fn parse_cargo_toml(path: &Path, contents: &str) -> crate::scanner::parser::project::CargoManifest {
    let mut manifest = crate::scanner::parser::project::CargoManifest::new(path.to_path_buf());
...
fn parse_visibility(vis: &syn::Visibility) -> crate::scanner::parser::ast::Visibility {
    match vis {
        syn::Visibility::Public(_) => crate::scanner::parser::ast::Visibility::Public,
        syn::Visibility::Restricted(restricted) => {
            if restricted.path.is_ident("crate") {
                crate::scanner::parser::ast::Visibility::PublicCrate
            } else {
                crate::scanner::parser::ast::Visibility::PublicSuper
            }
        }
        syn::Visibility::Inherited => crate::scanner::parser::ast::Visibility::Private,
    }
}
