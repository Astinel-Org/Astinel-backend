use crate::core::{Ast, DiagnosticSpan};
use std::any::Any;
...
pub struct ParsedProject {
    pub root: PathBuf,
    pub manifest: Option<crate::scanner::parser::project::CargoManifest>,
...
mod tests {
    ...
    fn all_contracts_iterator() {
        let file = ParsedFile {
            ...
            contracts: vec![ContractDef::new(
                "MyContract",
                DiagnosticSpan::new("c.rs", 1, 1),
            )],
            ..Default::default()
        };
